...
from .views import HeroListCreate, LoreFromGroup, LoreFromUndergroup, LoreGroupListCreate, LoreItemList, LoreListCreate, LoreListSingular, LoreLogsList, LorePeopleList, LoreRulesList, LoreUndergroupListCreate, PlayerListCreate, LoreTypeListCreate, LoreKnowledgeList, UndergroupFromGroup
...
urlpatterns = [
    ...
    path("player/", PlayerListCreate.as_view(), name="player"),
